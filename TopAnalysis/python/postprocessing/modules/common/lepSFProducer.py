...
class lepSFProducer(Module):
	...
	sf_mu_ISO, sf_muerr_ISO = [], []
	    ...
	    sf_muerr.append(np.sqrt(0.54778**2 * sf_muerr_BF[i] + 0.45222**2 * sf_muerr_GH[i]))
	    sf_muerr_Trig.append(np.sqrt(0.54778**2 * sf_muerr_Trig_BF[i] + 0.45222**2 * sf_muerr_Trig_GH[i]))
	    sf_muerr_ID.append(np.sqrt(0.54778**2 * sf_muerr_ID_BF[i] + 0.45222**2 * sf_muerr_ID_GH[i]))
	    sf_muerr_ISO.append(np.sqrt(0.54778**2 * sf_muerr_ISO_BF[i] + 0.45222**2 * sf_muerr_ISO_GH[i]))
